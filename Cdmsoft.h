...
public:
	...
	long ReadInt(long hwnd, LPCTSTR addr, long type)
	{
		...
		InvokeHelper(0x6f, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hwnd, addr, type);
		return result;
	}
	...
	long GetModuleBaseAddr(long hwnd, LPCTSTR module_name)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_BSTR ;
		InvokeHelper(0x76, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hwnd, module_name);
		return result;
	}
	...
	long AsmCall(long hwnd, long mode)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0x82, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hwnd, mode);
		return result;
	}
	...
	CString AsmCode(long base_addr)
	{
		CString result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x85, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, base_addr);
		return result;
	}
	CString Assemble(LPCTSTR asm_code, long base_addr, long is_upper)
	{
		...
		InvokeHelper(0x86, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, asm_code, base_addr, is_upper);
		return result;
	}
	...
	long VirtualAllocEx(long hwnd, long addr, long size, long type)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x140, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hwnd, addr, size, type);
		return result;
	}
	...
	long ReadIntAddr(long hwnd, long addr, long type)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x147, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hwnd, addr, type);
		return result;
	}
	...
	CString GetInfo(LPCTSTR cmd, LPCTSTR param)
	{
		CString result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x163, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, cmd, param);
		return result;
	}
	long FaqIsPosted()
	{
	...
	long LoadPicByte(long addr, long size, LPCTSTR name)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_BSTR ;
		InvokeHelper(0x165, DISPATCH_METHOD, VT_I4, (void*)&result, parms, addr, size, name);
		return result;
	}
	long MiddleDown()
	{
	...
	long FaqCaptureString(LPCTSTR str)
	{
		long result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x168, DISPATCH_METHOD, VT_I4, (void*)&result, parms, str);
		return result;
	}
	long VirtualProtectEx(long hwnd, long addr, long size, long type, long old_protect)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x169, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hwnd, addr, size, type, old_protect);
		return result;
	}
	long SetMouseSpeed(long speed)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x16a, DISPATCH_METHOD, VT_I4, (void*)&result, parms, speed);
		return result;
	}
	long GetMouseSpeed()
	{
	...
	long EnableMouseAccuracy(long en)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x16c, DISPATCH_METHOD, VT_I4, (void*)&result, parms, en);
		return result;
	}
