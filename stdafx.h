...
#include "botFunction.h"        //bot 的辅助处理函数
#include "Cdmsoft.h"            //大漠插件的函数，主要用于图色，此辅助的核心调用函数
#include "Adbshell.h"           //adb 函数，用于辅助与模拟器之间的通讯
//#include "MyTabCtrl.h"          
#include "Const.h"              //常量，将各种编号具体化
#ifdef _UNICODE
...
#elif defined _M_X64
#pragma comment(linker,"/manifestdependency:\"type='win32' name='Microsoft.Windows.Common-Controls' version='6.0.7600.16661' processorArchitecture='amd64' publicKeyToken='6595b64144ccf1df' language='*'\"")
#else
